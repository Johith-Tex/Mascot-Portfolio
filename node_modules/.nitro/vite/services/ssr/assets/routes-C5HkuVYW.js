import { t as texio_character_default } from "./texio-character-CyFhnXQh.js";
...
//#endregion
//#region src/components/SpiderCursor.tsx
/**
...
function SpiderCursor() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(motion.div, {
		...
		children: /* @__PURE__ */ jsxs(motion.div, {
			...
			children: [
				/* @__PURE__ */ jsx("span", { className: "absolute top-1/2 left-0 w-full h-px bg-[var(--cap-cream)]/45" }),
				/* @__PURE__ */ jsx("span", { className: "absolute left-1/2 top-0 h-full w-px bg-[var(--cap-cream)]/45" }),
				/* @__PURE__ */ jsx("span", { className: "absolute -top-1 left-1/2 -translate-x-1/2 w-px h-2 bg-[var(--cap-gold)]" }),
				/* @__PURE__ */ jsx("span", { className: "absolute -bottom-1 left-1/2 -translate-x-1/2 w-px h-2 bg-[var(--cap-gold)]" })
			]
		})
...
//#endregion
//#region src/components/ClickFX.tsx
/**
...
//#endregion
//#region src/components/AuroraBackground.tsx
function AuroraBackground() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 aurora-grid opacity-30 mix-blend-screen" }),
			stars.map((s) => /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "aurora-bolt aurora-bolt-1" }), /* @__PURE__ */ jsx("div", { className: "aurora-bolt aurora-bolt-2" })]
			})
		]
	});
}
//#endregion
//#region src/components/WebTransition.tsx
var WebContext = createContext(() => {});
var useWebPull = () => useContext(WebContext);
		...
		children: [/* @__PURE__ */ jsxs("svg", {
			...
			children: [
				...
				threads.map((_, i) => {
					...
					return /* @__PURE__ */ jsx(motion.line, {
						x1: x,
						y1: y,
						initial: {
							x2: x,
				...
				[
					...
					.75,
					1
				].map((s, i) => /* @__PURE__ */ jsx(motion.circle, {
					cx: x,
					cy: y,
					initial: {
						r: 30 * (i + 1),
...
function WebTransitionProvider({ children }) {
	...
	const trigger = useCallback((action, ev) => {
	...
	return /* @__PURE__ */ jsxs(WebContext.Provider, {
		value: trigger,
		children: [children, /* @__PURE__ */ jsx(AnimatePresence, { children: origin && /* @__PURE__ */ jsx(WebOverlay, {
			x: origin.x,
			y: origin.y
		}) })]
	});
...
//#endregion
//#region src/components/HeroesGrid.tsx
var HEROES = [
	{
		name: "MY DAD",
		role: "THE FOUNDATION",
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-8 h-px bg-[var(--cap-blue)]" }), "// INSPIRATIONS"]
				}),
				/* @__PURE__ */ jsxs("h2", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: HEROES.map((h, i) => /* @__PURE__ */ jsxs(motion.article, {
						initial: {
							opacity: 0,
							y: 30
						},
...
//#endregion
//#region src/components/GithubProjects.tsx
var CAR_IMAGES = [
...
function GithubProjects() {
	...
	if (error || vehicles.length === 0) return /* @__PURE__ */ jsx("section", {
		className: "h-screen flex items-center justify-center bg-black",
		children: /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx(DynamicBackground, {}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[var(--cap-gold)] animate-pulse" }), "LIVE GITHUB API"]
				}), /* @__PURE__ */ jsxs("h2", {
					className: "font-display text-4xl lg:text-5xl text-white tracking-wide",
					children: ["GITHUB ", /* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsxs(motion.div, {
							...
							children: [/* @__PURE__ */ jsxs("p", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: ["VIEW REPOSITORY ", /* @__PURE__ */ jsx("span", {
										"aria-hidden": true,
										children: "→"
									})]
								})]
...
function MascotAssistant() {
	const [currentVideo, setCurrentVideo] = useState(texio_idle_whistle_bg_default);
	...
	return /* @__PURE__ */ jsxs(motion.div, {
		...
		children: [/* @__PURE__ */ jsx(AnimatePresence, { children: isTalking && /* @__PURE__ */ jsxs(motion.div, {
			initial: {
				opacity: 0,
				scale: .8,
				y: 20
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute -bottom-3 right-6 w-0 h-0 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-t-[12px] border-t-[var(--cap-gold)]" }),
				/* @__PURE__ */ jsx("div", { className: "absolute -bottom-[10px] right-[25px] w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[10px] border-t-[var(--surface-2)]" })
			]
		}) }), /* @__PURE__ */ jsx(motion.div, {
			...
			children: [
				/* @__PURE__ */ jsxs("a", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("span", { className: "ml-1 inline-block w-1.5 h-5 bg-[var(--cap-gold)] animate-pulse-glow" })
					]
				}),
				/* @__PURE__ */ jsx("nav", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "h-[2px] w-10 bg-[var(--cap-red)]" }),
					/* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(motion.div, {
						...
						className: "relative",
						children: /* @__PURE__ */ jsx(MarvelTitleCard, {})
					}),
...
function Character() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
		className: "px-6",
		children: /* @__PURE__ */ jsx("div", { className: "section-divider" })
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(motion.div, {
				...
				children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-8 h-px bg-[var(--cap-red)]" }), "// CHARACTER FILE"]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "absolute -inset-4 bg-gradient-to-br from-[var(--cap-red)]/30 via-[var(--cap-gold)]/15 to-transparent blur-3xl" }), /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "animate-pulse-glow inline-block w-1.5 h-1.5 rounded-full bg-[var(--cap-blue)] mr-1" }), "LIVE"]
							})
						]
					})]
				}), /* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						/* @__PURE__ */ jsxs("h2", {
							...
							children: ["MEET ", /* @__PURE__ */ jsx("span", {
								className: "marvel-title",
								children: "TEXIO"
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 bg-[var(--cap-red)]" }), "AKA JOHITH"]
						}),
						/* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								"VFX SHADERS",
								"LIGHTNING SYSTEM"
							].map((t) => /* @__PURE__ */ jsx(motion.span, {
								whileHover: {
									scale: 1.05,
									borderColor: "var(--cap-gold)"
								},
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-8 h-px bg-[var(--cap-red)]" }), "// MISSION LOG"]
					}), /* @__PURE__ */ jsxs("h2", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: p.n
								}), p.progress > 0 && /* @__PURE__ */ jsxs("span", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "font-mono text-xs text-[var(--cap-red)] mb-3 flex items-center gap-3",
						children: [/* @__PURE__ */ jsx("span", { className: "inline-block w-8 h-px bg-[var(--cap-red)]" }), "// FIELD JOURNAL"]
					}), /* @__PURE__ */ jsxs("h2", {
						className: "font-display text-5xl lg:text-6xl",
						children: ["DEVELOPMENT ", /* @__PURE__ */ jsx("span", {
							className: "marvel-title",
							children: "UPDATES"
						})]
					})]
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("div", {
						className: "space-y-5",
						children: DEVLOG.map((d, i) => /* @__PURE__ */ jsxs(motion.div, {
							variants: REVEAL_LEFT,
							custom: i * .5,
							initial: "hidden",
							whileInView: "visible",
				...
				children: [/* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-[var(--cap-gold)] animate-pulse-glow" }), "// AVAILABLE FOR WORK"]
						}),
						/* @__PURE__ */ jsxs("h2", {
							className: "font-display text-5xl lg:text-6xl leading-none",
							children: [
					...
					children: SERVICES.map((s, i) => /* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", {
								...
								children: s.items.map((it) => /* @__PURE__ */ jsxs("li", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[var(--cap-gold)] animate-pulse-glow" }), " LIVE"]
							})]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								["24/7", "Chat"],
								["DEVS", "Online"]
							].map(([a, b]) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
								className: "font-display text-2xl text-[var(--cap-gold)]",
								children: a
							}), /* @__PURE__ */ jsx("div", {
								className: "font-mono text-[10px] tracking-widest text-muted-foreground",
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("h2", {
					className: "font-display text-5xl lg:text-6xl",
					children: ["GET IN ", /* @__PURE__ */ jsx("span", {
						className: "marvel-title",
						children: "TOUCH"
					})]
				}),
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								children: [
									...
									"Software",
									"Other"
								].map((o) => /* @__PURE__ */ jsx("option", { children: o }, o))
							})] }),
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								className: "font-mono text-[10px] tracking-widest text-muted-foreground",
...
function Footer() {
	return /* @__PURE__ */ jsxs("footer", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "section-divider mb-0" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: "TEXIO"
				}), /* @__PURE__ */ jsx("span", { children: "// © 2026 · BUILT WITH PURPOSE" })]
			}), /* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-4",
				children: [/* @__PURE__ */ jsx("span", { children: "UNREAL ENGINE · REACT · THREE.JS" }), /* @__PURE__ */ jsxs("span", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[var(--cap-gold)] animate-pulse-glow" }), "MADE WITH PASSION"]
				})]
			})]
		})]
	});
...
function Index() {
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			/* @__PURE__ */ jsx(Nav, {}),
			/* @__PURE__ */ jsx(Hero, {}),
			/* @__PURE__ */ jsx(Character, {}),
			/* @__PURE__ */ jsx(Projects, {}),
			/* @__PURE__ */ jsx(GithubProjects, {}),
			/* @__PURE__ */ jsx("div", {
				className: "px-6",
				children: /* @__PURE__ */ jsx("div", { className: "section-divider" })
			}),
			/* @__PURE__ */ jsx(HeroesGrid, {}),
			/* @__PURE__ */ jsx(Devlog, {}),
			/* @__PURE__ */ jsx(Hire, {}),
			/* @__PURE__ */ jsx("div", {
				className: "px-6",
			...
			/* @__PURE__ */ jsx(MascotAssistant, {}),
			/* @__PURE__ */ jsx(Footer, {})
		]
	});
}
function IndexWithWeb() {
	return /* @__PURE__ */ jsxs(WebTransitionProvider, { children: [
		/* @__PURE__ */ jsx(AuroraBackground, {}),
		/* @__PURE__ */ jsxs(ClientOnly, { children: [
			/* @__PURE__ */ jsx(SpiderCursor, {}),
			/* @__PURE__ */ jsx(ClickFX, {}),
